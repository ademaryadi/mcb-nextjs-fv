...
const VerticalMenu = ({ dictionary, scrollMenu }) => {
  ...
  return (
    ...
    >
      ...
      >
        <MenuSection label={dictionary['navigation'].company} icon={<i className='tabler-files' />}>
          <MenuItem href={`/${locale}/_mcb/master`}>{dictionary['navigation'].companyData}</MenuItem>
          {/* <MenuItem href={'/${locale}/_mcb/master'}>{dictionary['navigation'].companyData}</MenuItem> */}
